  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        statements: [
          ["content","note.text",["loc",[null,[32,24],[32,37]]]]
        ],
        locals: ["note"],
        templates: []
      };
    ...
    var child2 = (function() {
      return {
        ...
        statements: [
          ["inline","textarea",[],["value",["subexpr","@mut",[["get","newNoteText",["loc",[null,[38,14],[38,25]]]]],[],[]]],["loc",[null,[37,6],[39,8]]]],
          ["element","action",["createNote"],[],["loc",[null,[41,8],[41,31]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child3 = (function() {
      return {
        ...
        statements: [
          ["element","action",["addNewNote"],[],["loc",[null,[47,6],[47,29]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.appendChild(el2, el3);
        var el3 = dom.createElement("div");
        dom.setAttribute(el3,"class","recipe-notes");
        var el4 = dom.createTextNode("\n");
        dom.appendChild(el3, el4);
        var el4 = dom.createComment("");
        dom.appendChild(el3, el4);
      ...
      statements: [
        ...
        ["block","each",[["get","notes",["loc",[null,[31,14],[31,19]]]]],[],1,null,["loc",[null,[31,6],[34,15]]]],
        ["block","if",[["get","isWritingNote",["loc",[null,[36,10],[36,23]]]]],[],2,3,["loc",[null,[36,4],[50,11]]]]
      ],
      locals: [],
...
define('frontend/tests/recipe/controller.jshint', function () {
  ...
  QUnit.test('recipe/controller.js should pass jshint', function(assert) { 
    assert.ok(false, 'recipe/controller.js should pass jshint.\nrecipe/controller.js: line 29, col 35, Missing semicolon.\nrecipe/controller.js: line 43, col 9, Missing semicolon.\n\n2 errors'); 
  });
