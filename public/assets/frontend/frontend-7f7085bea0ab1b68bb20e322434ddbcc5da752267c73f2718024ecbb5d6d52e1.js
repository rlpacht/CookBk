...
define('frontend/components/note-item/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","isEditing",["loc",[null,[2,8],[2,17]]]]],[],0,1,["loc",[null,[2,2],[18,9]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
...
define('frontend/components/recipe-tile/component', ['exports', 'ember'], function (exports, Ember) {
  ...
  var RecipeTileComponent = Ember['default'].Component.extend({
    ...
    formattedRecipeName: Ember['default'].computed(function () {
      var recipeName = this.get("recipe.name");
      if (recipeName.length > 36) {
        var formattedName = formattedRecipeName.slice(0, 37);
        formattedName += "...";
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ...
        ["inline","link-to",[["get","formattedRecipeName",["loc",[null,[23,12],[23,31]]]],"recipe",["get","recipe",["loc",[null,[23,41],[23,47]]]]],[],["loc",[null,[23,2],[23,49]]]]
      ],
      locals: [],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[3] = dom.createMorphAt(dom.childAt(element4, [3, 1]),5,5);
      ...
      statements: [
        ["content","recipe.name",["loc",[null,[3,4],[3,19]]]],
        ["attribute","href",["get","recipe.sourceUrl",["loc",[null,[8,13],[8,29]]]]],
...
define('frontend/tests/components/recipe-tile/component.jshint', function () {
  ...
  QUnit.test('components/recipe-tile/component.js should pass jshint', function(assert) { 
    assert.ok(false, 'components/recipe-tile/component.js should pass jshint.\ncomponents/recipe-tile/component.js: line 23, col 27, \'formattedRecipeName\' is not defined.\n\n1 error'); 
  });
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+27b58e45"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+27b58e45"});
}
