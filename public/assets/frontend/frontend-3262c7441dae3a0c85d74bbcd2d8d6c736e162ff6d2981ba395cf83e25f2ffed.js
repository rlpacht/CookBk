...
define('frontend/favorites/loading/route', ['exports', 'ember'], function (exports, Ember) {
...
define('frontend/favorites/loading/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "frontend/favorites/loading/template.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('frontend/tests/favorites/loading/route.jshint', function () {

  'use strict';

  QUnit.module('JSHint - favorites/loading');
  QUnit.test('favorites/loading/route.js should pass jshint', function(assert) { 
    assert.ok(false, 'favorites/loading/route.js should pass jshint.\nfavorites/loading/route.js: line 5, col 5, Forgotten \'debugger\' statement?\nfavorites/loading/route.js: line 5, col 13, Missing semicolon.\nfavorites/loading/route.js: line 9, col 5, Forgotten \'debugger\' statement?\nfavorites/loading/route.js: line 9, col 13, Missing semicolon.\nfavorites/loading/route.js: line 13, col 5, Forgotten \'debugger\' statement?\nfavorites/loading/route.js: line 13, col 13, Missing semicolon.\n\n6 errors'); 
  });
...
define('frontend/tests/recipes/loading/route.jshint', function () {
  ...
  QUnit.test('recipes/loading/route.js should pass jshint', function(assert) { 
    assert.ok(false, 'recipes/loading/route.js should pass jshint.\nrecipes/loading/route.js: line 5, col 5, Forgotten \'debugger\' statement?\nrecipes/loading/route.js: line 5, col 13, Missing semicolon.\nrecipes/loading/route.js: line 9, col 5, Forgotten \'debugger\' statement?\nrecipes/loading/route.js: line 9, col 13, Missing semicolon.\nrecipes/loading/route.js: line 13, col 5, Forgotten \'debugger\' statement?\nrecipes/loading/route.js: line 13, col 13, Missing semicolon.\n\n6 errors'); 
  });
...
define('frontend/tests/unit/favorites/loading/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:favorites/loading', 'Unit | Route | favorites/loading', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('frontend/tests/unit/favorites/loading/route-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - unit/favorites/loading');
  QUnit.test('unit/favorites/loading/route-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'unit/favorites/loading/route-test.js should pass jshint.'); 
  });
