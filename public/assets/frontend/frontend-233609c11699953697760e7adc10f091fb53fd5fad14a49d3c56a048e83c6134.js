    ...
    var child1 = (function() {
      var child0 = (function() {
        return {
          ...
          statements: [
            ["inline","recipe-tile",[],["addToFavorites","addToFavorites","removeFromFavorites","removeFromFavorites","recipe",["subexpr","@mut",[["get","recipe",["loc",[null,[11,15],[11,21]]]]],[],[]],"faves",["subexpr","@mut",[["get","initialFavoritedRecipes",["loc",[null,[12,14],[12,37]]]]],[],[]],"favoritesPage",true],["loc",[null,[8,6],[14,8]]]]
          ],
          locals: ["recipe"],
          templates: []
        };
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+7e7d729b"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+7e7d729b"});
}
