...
define('frontend/recipe/route', ['exports', 'ember'], function (exports, Ember) {
  ...
  var RecipeRoute = Ember['default'].Route.extend({
    ...
    setupController: function setupController(controller, recipe) {
      console.log('inside setupController');
      recipe.get('notes').then(function (notes) {
        debugger;
      });
    }
