  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child2 = (function() {
      return {
        ...
        buildFragment: function buildFragment(dom) {
          ...
          dom.appendChild(el1, el2);
          var el2 = dom.createElement("button");
          dom.setAttribute(el2,"class","save-note-button btn btn-success");
          var el3 = dom.createTextNode("\n              Save\n            ");
          dom.appendChild(el2, el3);
          dom.appendChild(el1, el2);
          var el2 = dom.createTextNode("\n          ");
        ...
        statements: [
          ["inline","textarea",[],["value",["subexpr","@mut",[["get","newNoteText",["loc",[null,[52,20],[52,31]]]]],[],[]],"enter","addNewNote"],["loc",[null,[51,12],[54,14]]]],
          ["element","action",["createNote"],[],["loc",[null,[59,14],[59,37]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child3 = (function() {
      return {
        ...
        statements: [
          ["element","action",["addNewNote"],[],["loc",[null,[65,12],[65,35]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ...
        ["block","if",[["get","isWritingNote",["loc",[null,[49,14],[49,27]]]]],[],2,3,["loc",[null,[49,8],[68,15]]]]
      ],
      locals: [],
...
define('frontend/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"frontend","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"frontend","version":"0.0.0+4990b8a9"},"contentSecurityPolicyHeader":"Content-Security-Policy-Report-Only","contentSecurityPolicy":{"default-src":"'none'","script-src":"'self' 'unsafe-eval'","font-src":"'self'","connect-src":"'self'","img-src":"'self'","style-src":"'self'","media-src":"'self'"},"exportApplicationGlobal":true}};
});

if (runningTests) {
  require("frontend/tests/test-helper");
} else {
  require("frontend/app")["default"].create({"name":"frontend","version":"0.0.0+4990b8a9"});
}
