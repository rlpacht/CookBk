...
define('frontend/application/loading/route', ['exports', 'ember'], function (exports, Ember) {
...
define('frontend/application/loading/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      meta: {
        ...
        "moduleName": "frontend/application/loading/template.hbs"
      },
      arity: 0,
      cachedFragment: null,
      hasRendered: false,
...
define('frontend/tests/application/loading/route.jshint', function () {

  'use strict';

  QUnit.module('JSHint - application/loading');
  QUnit.test('application/loading/route.js should pass jshint', function(assert) { 
    assert.ok(true, 'application/loading/route.js should pass jshint.'); 
  });
...
define('frontend/tests/unit/application/loading/route-test', ['ember-qunit'], function (ember_qunit) {

  'use strict';

  ember_qunit.moduleFor('route:application/loading', 'Unit | Route | application/loading', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('frontend/tests/unit/application/loading/route-test.jshint', function () {

  'use strict';

  QUnit.module('JSHint - unit/application/loading');
  QUnit.test('unit/application/loading/route-test.js should pass jshint', function(assert) { 
    assert.ok(true, 'unit/application/loading/route-test.js should pass jshint.'); 
  });
