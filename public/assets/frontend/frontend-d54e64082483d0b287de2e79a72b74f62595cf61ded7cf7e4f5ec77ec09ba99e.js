  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["content","debugger",["loc",[null,[2,2],[2,14]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child1 = (function() {
      var child0 = (function() {
        return {
          ...
          statements: [
            ["inline","recipe-tile",[],["addToFavorites","addToFavorites","removeFromFavorites","removeFromFavorites","recipe",["subexpr","@mut",[["get","recipe",["loc",[null,[13,15],[13,21]]]]],[],[]],"faves",["subexpr","@mut",[["get","favoritedRecipes",["loc",[null,[14,14],[14,30]]]]],[],[]],"favoritesPage",true],["loc",[null,[10,6],[16,8]]]]
          ],
          locals: ["recipe"],
          templates: []
        };
      ...
      return {
        ...
        statements: [
          ["content","debugger",["loc",[null,[8,4],[8,16]]]],
          ["block","each",[["get","initialFavoritedRecipes",["loc",[null,[9,12],[9,35]]]]],[],0,null,["loc",[null,[9,4],[17,13]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","isFavoritesEmpty",["loc",[null,[1,6],[1,22]]]]],[],0,1,["loc",[null,[1,0],[19,7]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
...
define('frontend/tests/favorites/route.jshint', function () {
  ...
  QUnit.test('favorites/route.js should pass jshint', function(assert) { 
    assert.ok(false, 'favorites/route.js should pass jshint.\nfavorites/route.js: line 12, col 5, Forgotten \'debugger\' statement?\nfavorites/route.js: line 12, col 13, Missing semicolon.\n\n2 errors'); 
  });
