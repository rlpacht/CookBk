  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      return {
        ...
        statements: [
          ["content","debugger",["loc",[null,[9,2],[9,14]]]],
          ["element","action",["removeFromFavorites"],[],["loc",[null,[12,4],[12,36]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child2 = (function() {
      return {
        ...
        statements: [
          ["content","debugger",["loc",[null,[16,2],[16,14]]]],
          ["element","action",["addToFavorites"],[],["loc",[null,[19,4],[19,31]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ...
        ["block","if",[["get","isFavorite",["loc",[null,[8,6],[8,16]]]]],[],1,2,["loc",[null,[8,0],[22,7]]]],
        ["inline","link-to",[["get","recipe.name",["loc",[null,[25,12],[25,23]]]],"recipe",["get","recipe",["loc",[null,[25,33],[25,39]]]]],[],["loc",[null,[25,2],[25,41]]]]
      ],
      locals: [],
...
define('frontend/tests/favorites/controller.jshint', function () {
  ...
  QUnit.test('favorites/controller.js should pass jshint', function(assert) { 
    assert.ok(false, 'favorites/controller.js should pass jshint.\nfavorites/controller.js: line 19, col 7, Forgotten \'debugger\' statement?\nfavorites/controller.js: line 19, col 15, Missing semicolon.\n\n2 errors'); 
  });
