...
define('frontend/favorites/template', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      var child0 = (function() {
        return {
          ...
          statements: [
            ["inline","recipe-tile",[],["addToFavorites","addToFavorites","removeFromFavorites","removeFromFavorites","recipe",["subexpr","@mut",[["get","recipe",["loc",[null,[12,15],[12,21]]]]],[],[]],"faves",["subexpr","@mut",[["get","favoritedRecipes",["loc",[null,[13,14],[13,30]]]]],[],[]],"favoritesPage",true],["loc",[null,[9,6],[15,8]]]]
          ],
          locals: ["recipe"],
          templates: []
        };
      ...
      return {
        ...
        statements: [
          ["content","debugger",["loc",[null,[7,4],[7,16]]]],
          ["block","each",[["get","initialFavoritedRecipes",["loc",[null,[8,12],[8,35]]]]],[],0,null,["loc",[null,[8,4],[16,13]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    return {
      ...
      statements: [
        ["block","if",[["get","isFavoritesEmpty",["loc",[null,[1,6],[1,22]]]]],[],0,1,["loc",[null,[1,0],[18,7]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
